...
class Foo {
  private bar = 1; // eslint-disable-line @tf/prefer-hash-private
  private static baz = 1; // eslint-disable-line @tf/prefer-hash-private
  // eslint-disable-next-line @tf/prefer-hash-private
  private foo() {
    this.bar = 2;
  }
  // eslint-disable-next-line @tf/prefer-hash-private
