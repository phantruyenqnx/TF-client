...
export const openDialog = {
  ...
  collaborateTitle: "Accelerate development with TF Data Platform",
  ...
  needHelp: "Need help?",
  needHelpDescription: "View our documentation, or check out the tutorials on the TF blog.",
  newToTFStudio: "New to TF Studio?",
  newToTFStudioDescription:
  ...
  openUrlDescription: "Use TF Data Platform to share data with your team.",
  ...
  signIn: "Sign in",
  startCollaborating: "Start collaborating with your TF organization",
  startCollaboratingDescription:
    "Make the most of your TF account – whether you want to dive deep on your data or share tools with your teammates.",
