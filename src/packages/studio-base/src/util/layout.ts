...
import { TabConfig, TabLocation, TabPanelConfig } from "@tf/studio-base/types/layouts";
import {
  PanelConfig,
  MosaicDropTargetPosition,
  SavedProps,
} from "@tf/studio-base/types/panels";
...
export const PANEL_TITLE_CONFIG_KEY = "tfPanelTitle";
