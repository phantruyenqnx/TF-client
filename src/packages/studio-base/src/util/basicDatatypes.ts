...
import { ros1, ros2galactic } from "@tf/rosmsg-msgs-common";
import { foxgloveMessageSchemas, generateRosMsgDefinition } from "@tf/schemas/internal";
import { RosDatatypes } from "@tf/studio-base/types/RosDatatypes";

/**
 * basicDatatypes is a map containing definitions for ROS common datatypes and TF datatypes
 * from the following packages:
 *
 * - @tf/rosmsgs-msg-common
 * - @tf/schemas
 */
...
// Add the legacy foxglove_msgs/ImageMarkerArray message definition (protocol compat)
