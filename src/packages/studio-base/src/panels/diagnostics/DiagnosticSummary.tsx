...
import useDiagnostics from "@tf/studio-base/panels/diagnostics/useDiagnostics";
import useStaleTime from "@tf/studio-base/panels/diagnostics/useStaleTime";
...
import toggle from "@tf/studio-base/util/toggle";
