...
import { LayoutActions } from "@tf/studio";
import {
  PanelContextMenu,
  PanelContextMenuItem,
} from "@tf/studio-base/components/PanelContextMenu";
import PublishGoalIcon from "@tf/studio-base/components/PublishGoalIcon";
import PublishPointIcon from "@tf/studio-base/components/PublishPointIcon";
import PublishPoseEstimateIcon from "@tf/studio-base/components/PublishPoseEstimateIcon";
import { usePanelMousePresence } from "@tf/studio-base/hooks/usePanelMousePresence";
import { HUD } from "@tf/studio-base/panels/ThreeDeeRender/HUD";
