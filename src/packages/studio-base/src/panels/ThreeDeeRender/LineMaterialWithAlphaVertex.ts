...
export class LineMaterialWithAlphaVertex extends ShaderMaterial {
  ...
  public constructor(parameters: LineMaterialParameters) {
    ...
    super({
      ...
      uniforms: UniformsUtils.clone((ShaderLib["tf.line"] as any).uniforms),

      vertexShader: (ShaderLib["tf.line"] as any).vertexShader,
      fragmentShader: (ShaderLib["tf.line"] as any).fragmentShader,
