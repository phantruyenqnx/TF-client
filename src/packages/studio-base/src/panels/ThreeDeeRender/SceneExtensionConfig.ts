...
import { Cameras } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Cameras";
import { TFGrid } from "@tf/studio-base/panels/ThreeDeeRender/renderables/TFGrid";
import { FrameAxes } from "@tf/studio-base/panels/ThreeDeeRender/renderables/FrameAxes";
import { Grids } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Grids";
import { ImageMode } from "@tf/studio-base/panels/ThreeDeeRender/renderables/ImageMode/ImageMode";
import { Images } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Images";
import { LaserScans } from "@tf/studio-base/panels/ThreeDeeRender/renderables/LaserScans";
import { Markers } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Markers";
import { OccupancyGrids } from "@tf/studio-base/panels/ThreeDeeRender/renderables/OccupancyGrids";
import { PointClouds } from "@tf/studio-base/panels/ThreeDeeRender/renderables/PointClouds";
import { Polygons } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Polygons";
import { PoseArrays } from "@tf/studio-base/panels/ThreeDeeRender/renderables/PoseArrays";
import { Poses } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Poses";
import { PublishSettings } from "@tf/studio-base/panels/ThreeDeeRender/renderables/PublishSettings";
import { TFSceneEntities } from "@tf/studio-base/panels/ThreeDeeRender/renderables/SceneEntities";
import { SceneSettings } from "@tf/studio-base/panels/ThreeDeeRender/renderables/SceneSettings";
import { Urdfs } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Urdfs";
import { VelodyneScans } from "@tf/studio-base/panels/ThreeDeeRender/renderables/VelodyneScans";
...
export const DEFAULT_SCENE_EXTENSION_CONFIG: SceneExtensionConfig = {
  ...
  extensionsById: {
    ...
    [TFSceneEntities.extensionId]: {
      init: (renderer: IRenderer) => new TFSceneEntities(renderer),
    },
    [TFGrid.extensionId]: {
      init: (renderer: IRenderer) => new TFGrid(renderer),
    },
