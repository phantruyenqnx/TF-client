...
import { Grid, NumericType } from "@tf/schemas";
import { MessageEvent } from "@tf/studio";
import { LayerSettingsTFGrid } from "@tf/studio-base/panels/ThreeDeeRender/renderables/TFGrid";
...
function TF_Grid_Uint8({
  ...
  topics.push({ name: "/grid2", schemaName: "tf.Grid" });
  ...
  topics.push({ name: "/grid3", schemaName: "tf.Grid" });
  ...
  topics.push({ name: "/grid4", schemaName: "tf.Grid" });
...
function TF_Grid_RGBA(): JSX.Element {
  const topics: Topic[] = [
    { name: "/grid", schemaName: "tf.Grid" },
    { name: "/tf", schemaName: "geometry_msgs/TransformStamped" },
  ];
...
export const TF_Grid_Uint8_Values: StoryObj = {
  render: () => <TF_Grid_Uint8 />,
};

export const TF_Grid_Uint8_Values_Clamped: StoryObj = {
  render: () => <TF_Grid_Uint8 minValue={30} maxValue={80} />,
};

export const TF_Grid_RGBA_Values: StoryObj = {
  render: () => <TF_Grid_RGBA />,
};

export const TF_Grid_Float_Values: StoryObj = {
  render: () => <TF_Grid_Float />,
};

export const TF_Grid_Float_Values_Clamped: StoryObj = {
  render: () => <TF_Grid_Float minValue={0.05} maxValue={0.1} />,
};

export const TF_Grid_Padded_Row: StoryObj = {
