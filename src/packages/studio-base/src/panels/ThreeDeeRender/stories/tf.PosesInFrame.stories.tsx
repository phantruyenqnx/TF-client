...
import { FrameTransform, PosesInFrame } from "@tf/schemas";
...
export const TF_PosesInFrame: StoryObj = {
...
export const TF_PosesInFrame_Chinese: StoryObj = {
  ...TF_PosesInFrame,
  parameters: { forceLanguage: "zh" },
};
export const TF_PosesInFrame_Japanese: StoryObj = {
  ...TF_PosesInFrame,
