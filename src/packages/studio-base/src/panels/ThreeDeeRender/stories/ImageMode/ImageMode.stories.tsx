...
} from "@tf/studio-base/panels/ThreeDeeRender/stories/ImageMode/imageCommon";
import { Topic } from "@tf/studio-base/players/types";
import PanelSetup, { Fixture } from "@tf/studio-base/stories/PanelSetup";
import delay from "@tf/studio-base/util/delay";
...
export const ImageModeTFRawImage: StoryObj<typeof ImageModeTFImage> = {
  render: ImageModeTFImage,
  args: { imageType: "raw" },
};

export const ImageModeTFPngImage: StoryObj<typeof ImageModeTFImage> = {
  render: ImageModeTFImage,
  args: { imageType: "png" },
};

export const DownloadRawImage: StoryObj<typeof ImageModeTFImage> = {
    ...
    return (
      <Stack direction="row" fullHeight>
        <Stack style={{ width: "50%" }}>
          <ImageModeTFImage {...args} onDownloadImage={onDownloadImage} />
        </Stack>
...
export const DownloadPngImage: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png" },
};

export const DownloadPngImageFlipH: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", flipHorizontal: true },
};

export const DownloadPngImageFlipV: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", flipVertical: true },
};

export const DownloadPngImageFlipHV: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", flipHorizontal: true, flipVertical: true },
};

export const DownloadPngImage90: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", rotation: 90 },
};

export const DownloadPngImage180: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", rotation: 180 },
};

export const DownloadPngImage270: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", rotation: 270 },
};

export const DownloadPngImage90FlipH: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", rotation: 90, flipHorizontal: true },
};

export const DownloadPngImage90FlipV: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", rotation: 90, flipVertical: true },
};

export const DownloadPngImage90FlipHV: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "png", rotation: 90, flipHorizontal: true, flipVertical: true },
};

export const DownloadMono16Image: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "raw_mono16" },
};
export const DownloadMono16ImageCustomMinMax: StoryObj<typeof ImageModeTFImage> = {
  ...DownloadRawImage,
  args: { imageType: "raw_mono16", minValue: 10000, maxValue: 20000 },
};

export const ImageModeResizeHandled: StoryObj<typeof ImageModeTFImage> = {
  render: ImageModeTFImage,
  args: { imageType: "raw" },
...
export const ImageModePick: StoryObj<typeof ImageModeTFImage> = {
  render: ImageModeTFImage,
  args: { imageType: "raw" },
