...
import { fromSec } from "@tf/rostime";
import { FrameTransform, LaserScan, PointCloud } from "@tf/schemas";
import { MessageEvent } from "@tf/studio";
import { xyzrpyToPose } from "@tf/studio-base/panels/ThreeDeeRender/transforms";
import { Topic } from "@tf/studio-base/players/types";
import PanelSetup from "@tf/studio-base/stories/PanelSetup";
import { emptyPose } from "@tf/studio-base/util/Pose";
...
export default {
  title: "panels/ThreeDeeRender/tf.LaserScan",
  component: ThreeDeePanel,
  parameters: { colorScheme: "dark" },
};

function TF_LaserScan({
  time = 0,
  rangeMin = 0,
  rangeMax = 6,
  settings,
...
export const Square: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    settings: {
      pointShape: "square",
...
export const Size20: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    settings: {
      pointSize: 20,
...
export const FlatColor: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    settings: {
      colorMode: "flat",
...
export const CustomGradient: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    settings: {
      colorMode: "gradient",
...
export const RangeLimits: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    rangeMin: 2,
    rangeMax: 3,
...
export const Time0: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    time: 0,
  },
...
export const Time5: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    time: 5,
  },
...
export const Time10: StoryObj<Parameters<typeof TF_LaserScan>[0]> = {
  render: TF_LaserScan,
  args: {
    time: 10,
  },
