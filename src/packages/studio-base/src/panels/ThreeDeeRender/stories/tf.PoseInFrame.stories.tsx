...
import { FrameTransform, PoseInFrame } from "@tf/schemas";
...
export const TF_PoseInFrame: StoryObj = {
...
export const TF_PoseInFrame_Chinese: StoryObj = {
  ...TF_PoseInFrame,
  parameters: { forceLanguage: "zh" },
};
export const TF_PoseInFrame_Japanese: StoryObj = {
  ...TF_PoseInFrame,
