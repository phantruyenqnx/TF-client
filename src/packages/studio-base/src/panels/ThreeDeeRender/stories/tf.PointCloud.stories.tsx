...
import type { PointCloud } from "@tf/schemas";
import { MessageEvent } from "@tf/studio";
import { Topic } from "@tf/studio-base/players/types";
import PanelSetup from "@tf/studio-base/stories/PanelSetup";
...
export const TF_PointCloud_RGBA_Settings: StoryObj = {
  render: () => <TF_PointCloud includeSettings />,
  play: async () => {
...
export const TF_PointCloud_RGBA_SettingsChinese: StoryObj = {
  ...TF_PointCloud_RGBA_Settings,
  parameters: { forceLanguage: "zh" },
};
export const TF_PointCloud_RGBA_SettingsJapanese: StoryObj = {
  ...TF_PointCloud_RGBA_Settings,
  parameters: { forceLanguage: "ja" },
};

export const TF_PointCloud_Gradient_Settings: StoryObj = {
  render: () => <TF_PointCloud colorMode="gradient" includeSettings />,
  play: async () => {
    await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__general"));
    await userEvent.click(
      await screen.findByTestId("settings__nodeHeaderToggle__topics-/pointcloud"),
...
export const TF_PointCloud_Gradient_SettingsChinese: StoryObj = {
  ...TF_PointCloud_Gradient_Settings,
  parameters: { forceLanguage: "zh" },
};
export const TF_PointCloud_Gradient_SettingsJapanese: StoryObj = {
  ...TF_PointCloud_Gradient_Settings,
  parameters: { forceLanguage: "ja" },
};

export const TF_PointCloud_RGBA: StoryObj = {
  render: () => <TF_PointCloud />,
};

export const TF_PointCloud_RGBA_Square: StoryObj = {
  render: () => <TF_PointCloud pointShape="square" />,
};

export const TF_PointCloud_Gradient: StoryObj = {
  render: () => <TF_PointCloud colorMode="gradient" />,
};

export const TF_PointCloud_Gradient_Clamped: StoryObj = {
  render: () => <TF_PointCloud colorMode="gradient" minValue={-2} maxValue={2} />,
};

export const TF_PointCloud_Stixels: StoryObj = {
  render: () => <TF_PointCloud colorMode="gradient" stixelsEnabled={true} />,
};

function TF_PointCloud({
  pointShape = "circle",
...
function TF_PointCloud_Intensity_Base({
  minValue,
  maxValue,
}: {
  minValue?: number;
...
export const TF_PointCloud_Intensity: StoryObj = {
  render: () => TF_PointCloud_Intensity_Base({}),
};

export const TF_PointCloud_Intensity_Clamped: StoryObj = {
  render: () =>
    TF_PointCloud_Intensity_Base({
      minValue: 80,
      maxValue: 130,
    }),
};

export const TF_PointCloud_TwoDimensions: StoryObj = {
...
export const TF_PointCloud_HistoryPicking: StoryObj = {
...
/** Click first cloud */
export const TF_PointCloud_HistoryPickingInstances1: StoryObj = {
  render: HistoryPickingStory,
  async play() {
    await userEvent.click(await screen.findByTestId("ExpandingToolbar-Inspect objects"));
    await userEvent.pointer({
...
/** Click second cloud */
export const TF_PointCloud_HistoryPickingInstances2: StoryObj = {
  render: HistoryPickingStory,
  async play() {
    await userEvent.click(await screen.findByTestId("ExpandingToolbar-Inspect objects"));
    await userEvent.pointer({
...
export const TF_PointCloud_Distance: StoryObj = {
  render: () => <TF_PointCloud_Distance_Base />,
};

function TF_PointCloud_Distance_Base(): JSX.Element {
  const topics: Topic[] = [
    { name: "/pointcloud", schemaName: "foxglove.PointCloud" },
    { name: "/tf", schemaName: "geometry_msgs/TransformStamped" },
  ];
