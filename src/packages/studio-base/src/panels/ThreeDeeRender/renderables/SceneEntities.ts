...
import { SCENE_UPDATE_DATATYPES } from "../tfSchemas";
import {
  normalizeColorRGBA,
  normalizeColorRGBAs,
  normalizePose,
...
export class TFSceneEntities extends SceneExtension<TopicEntities> {
  public static extensionId = "tf.SceneEntities";
  #primitivePool = new PrimitivePool(this.renderer);

  public constructor(renderer: IRenderer, name: string = TFSceneEntities.extensionId) {
    super(name, renderer);
  }
