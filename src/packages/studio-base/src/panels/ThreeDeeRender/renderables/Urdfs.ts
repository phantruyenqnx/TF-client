...
import { UrdfGeometryMesh, UrdfRobot, UrdfVisual, parseRobot, UrdfJoint } from "@tf/den/urdf";
...
import { makeRgba, stringToRgba } from "@tf/studio-base/panels/ThreeDeeRender/color";
import { eulerToQuaternion } from "@tf/studio-base/util/geometry";
...
export class Urdfs extends SceneExtension<UrdfRenderable> {
  public static extensionId = "tf.Urdfs";
