...
import { LinePrimitive, LineType, SceneEntity } from "@tf/schemas";
import { LineMaterialWithAlphaVertex } from "@tf/studio-base/panels/ThreeDeeRender/LineMaterialWithAlphaVertex";
