...
import { LaserScan as TFLaserScan } from "@tf/schemas";
...
import { LASERSCAN_DATATYPES as TF_LASERSCAN_DATATYPES } from "../tfSchemas";
...
export class LaserScans extends SceneExtension<LaserScanHistoryRenderable> {
  ...
  public override getSubscriptions(): readonly AnyRendererSubscription[] {
    return [
      ...
      {
        type: "schema",
        schemaNames: TF_LASERSCAN_DATATYPES,
        subscription: {
          handler: this.#handleLaserScan,
          filterQueue: this.#processMessageQueue.bind(this),
        },
  ...
  #handleLaserScan = (
    messageEvent: PartialMessageEvent<RosLaserScan | TFLaserScan>,
  ): void => {
    const topic = messageEvent.topic;
    const laserScan =
      "header" in messageEvent.message
        ? normalizeRosLaserScan(messageEvent.message)
        : normalizeTFLaserScan(messageEvent.message as PartialMessage<TFLaserScan>);
...
function normalizeTFLaserScan(
  message: PartialMessage<TFLaserScan>,
): NormalizedLaserScan {
  return {
