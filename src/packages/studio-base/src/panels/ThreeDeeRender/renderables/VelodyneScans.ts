...
import { toNanoSec, toSec } from "@tf/rostime";
import { NumericType, PointCloud as TFPointCloud } from "@tf/schemas";
import { MessageEvent, SettingsTreeAction } from "@tf/studio";
import {
  createStixelMaterial,
  PointCloudHistoryRenderable,
} from "@tf/studio-base/panels/ThreeDeeRender/renderables/PointClouds";
import type { RosObject } from "@tf/studio-base/players/types";
import { VelodyneScan } from "@tf/studio-base/types/Messages";
import {
  Calibration,
  Model,
  PointCloud,
...
class VelodyneCloudConverter {
  ...
  public decode(scan: VelodyneScan): TFPointCloud | undefined {
...
export class VelodyneScans extends SceneExtension<PointCloudHistoryRenderable> {
  public static extensionId = "tf.VelodyneScans";
