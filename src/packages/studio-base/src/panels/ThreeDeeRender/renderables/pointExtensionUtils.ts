...
import { SettingsTreeNode, Topic } from "@tf/studio";
import { DynamicBufferGeometry } from "@tf/studio-base/panels/ThreeDeeRender/DynamicBufferGeometry";
import { IRenderer } from "@tf/studio-base/panels/ThreeDeeRender/IRenderer";
import { BaseUserData, Renderable } from "@tf/studio-base/panels/ThreeDeeRender/Renderable";
import { rgbaToCssString } from "@tf/studio-base/panels/ThreeDeeRender/color";
import {
  missingTransformMessage,
  MISSING_TRANSFORM,
} from "@tf/studio-base/panels/ThreeDeeRender/renderables/transforms";
import { BaseSettings } from "@tf/studio-base/panels/ThreeDeeRender/settings";
import { MAX_DURATION } from "@tf/studio-base/panels/ThreeDeeRender/transforms";
import { updatePose } from "@tf/studio-base/panels/ThreeDeeRender/updatePose";
...
export function pointSettingsNode(
  ...
  const colorModeFields = colorModeSettingsFields({
    ...
    modifiers: {
      ...
      supportsRgbaFieldsMode: TF_POINTCLOUD_DATATYPES.has(topic.schemaName),
    },
  });
