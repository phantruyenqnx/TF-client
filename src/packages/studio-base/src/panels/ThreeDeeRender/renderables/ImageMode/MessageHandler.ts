...
import {
  CompressedImage,
  RawImage,
  ImageAnnotations as TFImageAnnotations,
} from "@tf/schemas";
import { Immutable, MessageEvent } from "@tf/studio";
import {
  HUDItem,
  HUDItemManager,
} from "@tf/studio-base/panels/ThreeDeeRender/HUDItemManager";
import { ImageModeConfig } from "@tf/studio-base/panels/ThreeDeeRender/IRenderer";
import {
  AnyImage,
...
import {
  ...
  normalizeRosImage,
} from "@tf/studio-base/panels/ThreeDeeRender/renderables/Images/imageNormalizers";
import { normalizeCameraInfo } from "@tf/studio-base/panels/ThreeDeeRender/renderables/projections";
import {
  ImageMarker as RosImageMarker,
  ImageMarkerArray as RosImageMarkerArray,
} from "@tf/studio-base/types/Messages";
...
type NormalizedAnnotations = {
  ...
  originalMessage: MessageEvent<RosImageMarkerArray | RosImageMarker | TFImageAnnotations>;
...
export class MessageHandler implements IMessageHandler {
  ...
  public handleAnnotations = (
    messageEvent: MessageEvent<TFImageAnnotations | RosImageMarker | RosImageMarkerArray>,
  ): void => {
