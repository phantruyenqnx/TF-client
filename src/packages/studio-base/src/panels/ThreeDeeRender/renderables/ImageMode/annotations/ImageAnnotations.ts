...
import { ImageAnnotations as TFImageAnnotations } from "@tf/schemas";
import { Immutable, MessageEvent, SettingsTreeAction, Topic } from "@tf/studio";
import { Path } from "@tf/studio-base/panels/ThreeDeeRender/LayerErrors";
import { onlyLastByTopicMessage } from "@tf/studio-base/panels/ThreeDeeRender/SceneExtension";
import {
  ImageMarker as RosImageMarker,
  ImageMarkerArray as RosImageMarkerArray,
} from "@tf/studio-base/types/Messages";
import { LabelPool } from "@tf/three-text";
...
import { IMAGE_ANNOTATIONS_DATATYPES } from "../../../tfSchemas";
...
export class ImageAnnotations extends THREE.Object3D {
  ...
  #handleTopicVisibilityChange(
    topic: TopicName,
    visible: boolean, // eslint-disable-line @tf/no-boolean-parameters
  ): void {
