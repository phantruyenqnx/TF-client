...
import { PinholeCameraModel } from "@tf/den/image";
...
import { PanelContextMenuItem } from "@tf/studio-base/components/PanelContextMenu";
import { DraggedMessagePath } from "@tf/studio-base/components/PanelExtensionAdapter";
import { HUDItem } from "@tf/studio-base/panels/ThreeDeeRender/HUDItemManager";
import { Path } from "@tf/studio-base/panels/ThreeDeeRender/LayerErrors";
import {
  IMAGE_MODE_HUD_GROUP_ID,
  IMAGE_TOPIC_PATH,
} from "@tf/studio-base/panels/ThreeDeeRender/renderables/ImageMode/constants";
import {
  IMAGE_RENDERABLE_DEFAULT_SETTINGS,
  ImageRenderable,
  ImageRenderableSettings,
  ImageUserData,
} from "@tf/studio-base/panels/ThreeDeeRender/renderables/Images/ImageRenderable";
import {
  AnyImage,
  getFrameIdFromImage,
} from "@tf/studio-base/panels/ThreeDeeRender/renderables/Images/ImageTypes";
import { IMAGE_DEFAULT_COLOR_MODE_SETTINGS } from "@tf/studio-base/panels/ThreeDeeRender/renderables/Images/decodeImage";
import {
  cameraInfosEqual,
  normalizeCameraInfo,
} from "@tf/studio-base/panels/ThreeDeeRender/renderables/projections";
import { t3D } from "@tf/studio-base/panels/ThreeDeeRender/t3D";
import { makePose } from "@tf/studio-base/panels/ThreeDeeRender/transforms";
import { AppEvent } from "@tf/studio-base/services/IAnalytics";
import { downloadFiles } from "@tf/studio-base/util/download";
...
{
  public static extensionId = "tf.ImageMode";
