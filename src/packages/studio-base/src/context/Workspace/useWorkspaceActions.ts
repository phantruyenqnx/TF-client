...
import { useGuaranteedContext } from "@tf/hooks";
import { AppSettingsTab } from "@tf/studio-base/components/AppSettingsDialog/AppSettingsDialog";
import { DataSourceDialogItem } from "@tf/studio-base/components/DataSourceDialog";
...
import { downloadTextFile } from "@tf/studio-base/util/download";
...
export function useWorkspaceActions(): WorkspaceActions {
  ...
  const exportLayoutToFile = useCallback(() => {
    ...
    const name = getCurrentLayoutState().selectedLayout?.name ?? "tf-layout";
