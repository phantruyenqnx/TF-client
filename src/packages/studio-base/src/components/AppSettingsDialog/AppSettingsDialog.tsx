...
import { AppSetting } from "@tf/studio-base";
import OsContextSingleton from "@tf/studio-base/OsContextSingleton";
import CopyButton from "@tf/studio-base/components/CopyButton";
import { ExperimentalFeatureSettings } from "@tf/studio-base/components/ExperimentalFeatureSettings";
import TFLogoText from "@tf/studio-base/components/TFLogoText";
...
import isDesktopApp from "@tf/studio-base/util/isDesktopApp";
...
>([
  [
    "resources",
    {
      ...
      links: [
        ...(isDesktopApp() ? [] : [{ title: "Desktop app", url: "#" }]),
        { title: "Browse docs", url: "#" },
        { title: "Join our community", url: "#" },
      ],
    },
  ],
  [
  ...
  [
    "contact",
    {
      subheader: "Contact",
      links: [
        { title: "Give feedback", url: "#" },
        { title: "Schedule a demo", url: "#" },
      ],
    },
  ],
  [
        ...
        <Stack direction="row" fullHeight overflowY="auto">
          ...
          >
            <Stack gap={2} alignItems="flex-start">
              <header>
                <TFLogoText color="primary" className={classes.logo} />
              </header>
              <Stack direction="row" alignItems="center" gap={1}>
                <Typography variant="body2">
                  TF Studio version {TF_STUDIO_VERSION}
                </Typography>
                <CopyButton
                  size="small"
                  getText={() => TF_STUDIO_VERSION?.toString() ?? ""}
                />
              </Stack>
              {[
