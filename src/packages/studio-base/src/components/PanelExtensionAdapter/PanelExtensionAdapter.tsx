...
import { useValueChangedDebugLog, useSynchronousMountedState } from "@tf/hooks";
import Logger from "@tf/log";
import { fromSec, toSec } from "@tf/rostime";
import {
  AppSettingValue,
...
import { useAppConfiguration } from "@tf/studio-base/context/AppConfigurationContext";
import {
  ExtensionCatalog,
  useExtensionCatalog,
...
} from "@tf/studio-base/providers/PanelStateContextProvider";
import { PanelConfig, SaveConfig } from "@tf/studio-base/types/panels";
import { assertNever } from "@tf/studio-base/util/assertNever";
...
export const VERSION_CONFIG_KEY = "tfConfigVersion";
...
type PanelExtensionAdapterProps = {
   ...
   * numbered tfConfigVersion property in their config to control this.
   */
