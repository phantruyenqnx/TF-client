...
/// <reference types="@tf/chartjs-plugin-zoom" />
...
import { type ZoomPluginOptions } from "@tf/chartjs-plugin-zoom/types/options";
import Logger from "@tf/log";
import ChartJsMux, {
  ChartUpdateMessage,
} from "@tf/studio-base/components/Chart/worker/ChartJsMux";
import Rpc, { createLinkedChannels } from "@tf/studio-base/util/Rpc";
import WebWorkerManager from "@tf/studio-base/util/WebWorkerManager";
