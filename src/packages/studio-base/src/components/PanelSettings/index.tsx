...
import { PanelConfig } from "@tf/studio-base/types/panels";
import { TAB_PANEL_TYPE } from "@tf/studio-base/util/globalConstants";
import { getPanelTypeFromId } from "@tf/studio-base/util/layout";
