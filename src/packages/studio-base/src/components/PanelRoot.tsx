...
import { APP_BAR_HEIGHT } from "@tf/studio-base/components/AppBar/constants";

export const PANEL_ROOT_CLASS_NAME = "TFPanelRoot-root";
...
const useStyles = makeStyles<Omit<PanelRootProps, "fullscreenState" | "selected">>()((
  ...
  return {
    ...
    exited: {
      ...
      // ), but it also makes fullscreen panels get
