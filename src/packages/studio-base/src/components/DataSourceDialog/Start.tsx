...
import { DataSourceDialogItem } from "@tf/studio-base/components/DataSourceDialog/DataSourceDialog";
import TFLogoText from "@tf/studio-base/components/TFLogoText";
import Stack from "@tf/studio-base/components/Stack";
import TextMiddleTruncate from "@tf/studio-base/components/TextMiddleTruncate";
...
function SidebarItems(props: {
  ...
  const { freeUser, teamOrEnterpriseUser } = useMemo(() => {
    const demoItem = {
      id: "new",
      title: t("newToTFStudio"),
      text: t("newToTFStudioDescription"),
      actions: (
        <>
          <Button
            onClick={() => {
