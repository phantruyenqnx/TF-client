...
const globalWithHandler = global as { tfStudioReportErrorFn?: ReportErrorHandler };
...
export function reportError(error: Error): void {
  globalWithHandler.tfStudioReportErrorFn?.(error);
}
...
export function setReportErrorHandler(fn: ReportErrorHandler): void {
  globalWithHandler.tfStudioReportErrorFn = fn;
}
