...
import { IterablePlayer, WorkerIterableSource } from "@tf/studio-base/players/IterablePlayer";
...
const initWorkers: Record<string, () => Worker> = {
  ".bag": () => {
    return new Worker(
      ...
      new URL(
        "@tf/studio-base/players/IterablePlayer/BagIterableSourceWorker.worker",
        import.meta.url,
      ),
    );
  },
  ".mcap": () => {
    return new Worker(
      // tf-depcheck-used: babel-plugin-transform-import-meta
      new URL(
        "@tf/studio-base/players/IterablePlayer/Mcap/McapIterableSourceWorker.worker",
        import.meta.url,
      ),
    );
  },
...
class RemoteDataSourceFactory implements IDataSourceFactory {
  ...
  public warning = (
    <>
      ...
      <Link href="https://tf-platform.dev/data-platform" target="_blank">
        TF Data Platform
      </Link>
      .
    </>
