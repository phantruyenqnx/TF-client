...
import { useStateToURLSynchronization } from "@tf/studio-base/hooks/useStateToURLSynchronization";
import EventsProvider from "@tf/studio-base/providers/EventsProvider";

jest.mock("@tf/studio-base/context/CurrentLayoutContext");
jest.mock("@tf/studio-base/components/MessagePipeline");
