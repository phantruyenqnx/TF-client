...
import MockMessagePipelineProvider from "@tf/studio-base/components/MessagePipeline/MockMessagePipelineProvider";
import SettingsTreeEditor from "@tf/studio-base/components/SettingsTreeEditor";
import AppConfigurationContext from "@tf/studio-base/context/AppConfigurationContext";
import { useCurrentLayoutActions } from "@tf/studio-base/context/CurrentLayoutContext";
import { PanelsActions } from "@tf/studio-base/context/CurrentLayoutContext/actions";
import {
  ExtensionCatalog,
  ExtensionCatalogContext,
} from "@tf/studio-base/context/ExtensionCatalogContext";
import PanelCatalogContext, {
  PanelCatalog,
} from "@tf/studio-base/context/PanelCatalogContext";
import {
  PanelStateStore,
  usePanelStateStore,
} from "@tf/studio-base/context/PanelStateContext";
import { GlobalVariables } from "@tf/studio-base/hooks/useGlobalVariables";
import * as panels from "@tf/studio-base/panels";
import {
  AdvertiseOptions,
...
import MockCurrentLayoutProvider from "@tf/studio-base/providers/CurrentLayoutProvider/MockCurrentLayoutProvider";
import { PanelStateContextProvider } from "@tf/studio-base/providers/PanelStateContextProvider";
import TimelineInteractionStateProvider from "@tf/studio-base/providers/TimelineInteractionStateProvider";
...
import { RosDatatypes } from "@tf/studio-base/types/RosDatatypes";
import { SavedProps, UserScripts } from "@tf/studio-base/types/panels";
...
const MosaicWrapper = ({ children }: { children: React.ReactNode }): JSX.Element => {
  return (
    <DndProvider backend={HTML5Backend}>
      <Mosaic
        className="mosaic-tf-theme" // prevent the default mosaic theme from being applied
        initialValue="mock"
        renderTile={(_id, path) => {
          return (
