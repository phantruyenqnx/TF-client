...
import { createMuiTheme } from "@tf/theme";
      ...
      <Stack direction={!isDismissable ? "column" : "row"} alignItems="center" gap={2}>
        ...
        <div>
          <Typography variant="subtitle2">
            {prompt} TF Studio currently requires Chrome v{MINIMUM_CHROME_VERSION}+.
          </Typography>

          {!isChrome && (
            <Typography variant="body2">
              TF Studio currently requires Chrome for full functionality.
            </Typography>
          )}
        </div>
      </Stack>
